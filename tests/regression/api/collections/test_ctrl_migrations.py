...
class TestApiMigrations(TestApiBase):

    def test__migrations_get(self):
        """Tests the Migrations collections through the Cver Api
        GET /migrations
        """
        assert self.login()
        request_args = {
...
# End File: cver/tests/regression/api/test_ctrl_migrations.py

"""
    ...
    CTRL Collection - Scanners
    Checks that all routes on /scanners are working properly.
...
class TestApiCollectionScanner(TestApiBase):

    def test__scanners_get(self):
        """Tests the Scanners collections through the Cver Api
        GET /scanners
        """
        assert self.login()
...
# End File: cver/tests/regression/api/collections/test_ctrl_scanners.py

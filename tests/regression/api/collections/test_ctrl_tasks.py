"""
    ...
    CTRL Tasks
        Checks that all routes on /tasks are working properly.
...
class TestApiTasks(TestApiBase):

    def test__tasks_get(self):
        """Tests the Tasks collections through the Cver Api
        GET /tasks
        """
        assert self.login()
        request_args = {
